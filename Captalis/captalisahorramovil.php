<?php header('P3P: CP="CAO PSA OUR"'); session_start(); session_regenerate_id();
	...
	//$_SESSION['miembroCAPTALIS'] = "xxxx";
	//$_SESSION['passwordCAPTALIS'] = "xxxx";
...
<iframe src="procesandoAhorramovil.php" id="fahorramovilmsg" name="fahorramovilmsg" width="100%" height="0" scrolling="auto" frameborder="0" style="visibility:hidden">No soporta Frames
	...
	<tr>
    	<td>
<iframe src="formularioAhorramovil.php" id="fahorramovil" name="fahorramovil" width="100%" height="<?php echo $_SESSION["heightCaptalis"]; ?>" scrolling="auto" frameborder="0">No soporta Frames
</iframe>
		</td>
    </tr>    
</table>
