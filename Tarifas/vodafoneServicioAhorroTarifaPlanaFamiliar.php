...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Servicio de ahorro Tarifa Plana Familiar</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Podrá hablar entre los miembros de su familia por 0 cent/min y sin pagar establecimiento de llamada, tanto si tienen contratos como tarjetas Vodafone hasta un máximo de 5 líneas.<br />&nbsp;</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				...
				<tr height="20">
                    ...
                    <td width="190" align="right">6 € por línea</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                    ...
                    <td width="190" align="right">0 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
...
<tr>
        ...
        <td width="6"><img src="./imagenes/bola2.gif"/></td>
   		<td width="402" align="left">Para las líneas de tarjeta, recarga obligatoria de 10€ al mes.</td>
    	<td width="5"></td>
    </tr>
	<tr>
  		<td height="2"></td>
    ...
    <tr>
    	<td width="5"></td>
        <td width="6"><img src="./imagenes/bola2.gif"/></td>
   		<td width="402" align="left">Límite de 1500 min/mes por línea</td>
    	<td width="5"></td>
    </tr>
	<tr>
  		<td height="6"></td>
