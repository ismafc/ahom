...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Contrato Decreciente</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;El precio final de la llamada dependerá del consumo que realice en el mes. <br />
					  &nbsp;</td>
                	<td width="10"></td>	
                </tr>				<tr height="20">
                	<td width="10"></td>	
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="20">
				    ...
				    <td width="270" align="left"><strong>- Consumo mensual hasta 50€:</strong></td>
                    <td width="90" align="right">0,16 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Consumo mensual entre 50€ y 70€:</strong></td>
				...
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Consumo mensual de más de 70€:</strong></td>
                  	<td width="90" align="right">0,11 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
