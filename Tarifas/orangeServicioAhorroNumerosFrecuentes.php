...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Servicio de ahorro N&uacute;meros Frecuentes</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Podrá elegir 5 números y ahorrar un 50% en las llamadas que haga a estos números. <br />&nbsp;</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
            <table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" colspan="2" align="left"><strong>Cuota mensual</strong></td>
				...
				<tr height="20">
				    ...
				    <td width="270" align="left"><strong>- Por cada móvil Orange:</strong></td>
                    <td width="90" align="right">1 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Por cada fijo:</strong></td>
                    <td width="90" align="right">1 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Por cada móvil de otro operador:</strong></td>
                    <td width="90" align="right">2 €</td>
                	<td width="10"></td>	
                </tr>
			</table>
		</td>
   	...
   	<tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="150" align="left"><strong>Números elegidos:</strong></td>
                    <td width="230" align="right">50 % descuento</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="150" align="left"><strong>Otros:</strong></td>
                  	<td width="230" align="right">Según modalidad contratada</td>
                	<td width="10"></td>	
                </tr>
             </table>
    	</td>
