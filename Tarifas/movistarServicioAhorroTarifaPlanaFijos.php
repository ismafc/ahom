...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Servicio de ahorro Tarifa Plana a Fijos</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Al contratar este servicio de ahorro tendrá 1000 minutos al mes para llamar a teléfonos fijos nacionales.<br />&nbsp;</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="310" align="left"><strong>Cuota mensual contrato:</strong></td>
                    <td width="70" align="right">18 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="310" align="left"><strong>Cuota mensual prepago:</strong></td>
                    <td width="70" align="right">20 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="310" align="left"><strong>Activación/desactivación llamando al 4404:</strong></td>
                    <td width="70" align="right">0,15 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="310" align="left"><strong>Activación/desactivación por SMS:</strong></td>
