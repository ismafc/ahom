...
<div id="areaTexto">
  ...
  <tr>
    <td width="2"></td>
    <td width="414" style="background-color:#F2AE0A;">Informaci&oacute;n de tarifas, contratos y tarjetas</td>
    <td width="2"></td>
  </tr>
  <tr>
...
/* <table width="418" border="0" cellspacing="0" cellpadding="0">
  <tr>
  	<td width="139" align="center"><a href="movistar.php"><img src="./imagenes/logoMovistar.gif" /></a></td>
    <td width="140" align="center"><img src="./imagenes/logoVodafone.gif" /></td>
    <td width="139" align="center"><img src="./imagenes/logoOrange.gif" /></td>
  </tr>
   </table> 
   */
		$sql = "SELECT id, nombre FROM operadores WHERE id!='99' ORDER BY nombre";
		...
		while ($i < $num_rows){
			if ($num_rows - $i >=3){
				echo "<table width=418 border=0 cellspacing=0 cellpadding=0>";
				echo "<tr height=100 valign=100>";
				$row_array = mysql_fetch_row($result);
				echo "<td width=139 align=center>";
				echo "<a href=\"indexOperadora.php?idOperador=".$row_array[0]."\">";
				echo "<img src=\"cargarImagenDB.php?type=LOGO&idOperador=".$row_array[0]."\" border=0/>";
				echo "</td>"; 
				$row_array = mysql_fetch_row($result);
				echo "<td width=140 align=center>";
				echo "<a href=\"indexOperadora.php?idOperador=".$row_array[0]."\">";
				echo "<img src=\"cargarImagenDB.php?type=LOGO&idOperador=".$row_array[0]."\" border=0/>";
				echo "</td>"; 
				$row_array = mysql_fetch_row($result);
			    ...
			    echo "</tr></table><br>";
				$i += 3;
			}else if ($num_rows - $i >= 2){
				echo "<table width=418 border=0 cellspacing=0 cellpadding=0>";
				echo "<tr height=100 valign=100>";
				$row_array = mysql_fetch_row($result);
				echo "<td width=209 align=center>";
				echo "<a href=\"indexOperadora.php?idOperador=".$row_array[0]."\">";
				echo "<img src=\"cargarImagenDB.php?type=LOGO&idOperador=".$row_array[0]."\" border=0/>";
				echo "</td>"; 
				$row_array = mysql_fetch_row($result);
			    ...
			    echo "</tr></table><br>";
				$i += 2;
			}else if ($num_rows - $i >= 1){
				echo "<table width=418 border=0 cellspacing=0 cellpadding=0>";
				echo "<tr height=100 valign=100>";
				$row_array = mysql_fetch_row($result);
				echo "<td width=418 align=center>";
				echo "<a href=\"indexOperadora.php?idOperador=".$row_array[0]."\">";
				echo "<img src=\"cargarImagenDB.php?type=LOGO&idOperador=".$row_array[0]."\" border=0/>";
				echo "</td>"; 
			    echo "</tr></table><br>";
