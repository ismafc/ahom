...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Contrato Mañana</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="20">
				    ...
				    <td width="270" align="left"><strong>- Mañanas y fines de semana:</strong></td>
                    <td width="90" align="right">0,06 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Laborables de 13 a 22h:</strong></td>
                    <td width="90" align="right">0,29 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				...
				<tr height="20">
				    ...
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Laborables de 13 a 22h:</strong></td>
                  	<td width="90" align="right">0,49 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
