...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Contrato Tarifa Plana Plus + SMS</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="20">
                    ...
                    <td width="90" align="right">27,9 € + 5 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" colspan="2" align="left"><strong>Fijos</strong></td>
				...
				<tr height="20">
				    ...
				    <td width="270" align="left"><strong>- Lunes a domingo 24h:</strong></td>
                    <td width="90" align="right">0 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" colspan="2" align="left"><strong>Móviles</strong></td>
                    <td width="90" align="right"></td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Lunes a domingo de 18:00h a 8:00h:</strong></td>
                    <td width="90" align="right">0 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Lunes a domingo de 8:00h a 18:00h:</strong></td>
                    <td width="90" align="right">21,6 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
   	...
   	<tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" colspan="2" align="left"><strong>Nacional</strong></td>
                    <td width="90" align="right"></td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
				...
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" colspan="2" align="left"><strong>Internacional:</strong></td>
...
<table width="418" border="0" cellspacing="0" cellpadding="0" class="Estilo6">
	<tr>
  	...
  	<tr>
		...
		<td width="402" align="left">Límite de llamadas a 0€: 1000 min./ciclo de facturación</td>
    	<td width="5"></td>
    </tr>	
	<tr>
  		<td height="2"></td>
  	...
  	<tr>
    	<td width="5"></td>
        <td width="6"><img src="./imagenes/bola2.gif"/></td>
		<td width="402" align="left">Máximo 500 minutos a móviles</td>
    	<td width="5"></td>
    </tr>	
	<tr>
  		<td height="2"></td>
  	...
  	<tr>
    	<td width="5"></td>
        <td width="6"><img src="./imagenes/bola2.gif"/></td>
		<td width="402" align="left">Límite de 100SMS/mes</td>
    	<td width="5"></td>
    </tr>	
    <tr>
  		<td height="6"></td>
