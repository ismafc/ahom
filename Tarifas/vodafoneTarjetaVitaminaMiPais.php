...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Tarjeta Vitamina Mi País</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Las llamadas a todos los clientes de Mi País por 5 cént/min<br />
					  &nbsp;</td>
                	<td width="10"></td>	
                </tr>
                <tr height="20">
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Cliente Mi País:</strong></td>
...
<tr>
        ...
        <td width="6"><img src="./imagenes/bola2.gif"/></td>
   		<td width="402" align="left">Es necesario estar dado de alta en el servicio Mi País.</td>
    	<td width="5"></td>
    </tr>
	<tr>
  		<td height="6"></td>
