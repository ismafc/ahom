...
<?php
	...
	$idServicioAhorro = isset ($_GET["idServicioAhorro"]) ? $_GET["idServicioAhorro"] : "";
	$idOperador = "";
...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Servicio de ahorro Bonos SMS</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ahorrará en el envio de SMS a móviles Orange adquiriendo el bono que mejor se adapte a su nivel de uso.<br />&nbsp;</td>
                	<td width="10"></td>	
                </tr>
            </table>
        </td>
			...
			<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
				    ...
				    <td width="145" align="left"></td>
               		<td width="95" align="center"><strong>Precio/Mes</strong></td>
	                <td width="95" align="center"><strong>Precio/SMS</strong></td>
               		<td width="95" align="center"><strong>Ahorro</strong></td>
          			<td width="10"></td>	
	            </tr>
				<tr height="20">
        			<td width="10"></td>	
				    <td width="145" align="left"><strong>Bono 50 SMS:</strong></td>
		            <td width="95" align="center">5 €</td>
		            <td width="95" align="center">0,10 €</td>
		            <td width="95" align="center">33 %</td>
		          	<td width="10"></td>	
		         </tr>
				<tr height="20">
        			<td width="10"></td>	
				    <td width="145" align="left"><strong>Bono 100 SMS:</strong></td>
		            <td width="95" align="center">8 €</td>
		            <td width="95" align="center">0,08 €</td>
		            <td width="95" align="center">46 %</td>
		          	<td width="10"></td>	
		         </tr>
				<tr height="20">
        			<td width="10"></td>	
				    <td width="145" align="left"><strong>Bono 200 SMS:</strong></td>
		            <td width="95" align="center">15 €</td>
		            <td width="95" align="center">0,075 €</td>
		            <td width="95" align="center">50 %</td>
		          	<td width="10"></td>	
		         </tr>
             </table>
		 </td>     
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;También puede optar por enviar todos los mensajes que quiera a un precio reducido.<br />&nbsp;</td>
                	<td width="10"></td>	
                </tr>
            </table>
        </td>
	    ...
	    <td width="400" style="background-color:#D7E9F5">
			<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
	            	<td width="10"></td>	
				    <td width="145" align="left"></td>
               		<td width="95" align="center"><strong>Cuota</strong></td>
	                <td width="95" align="center"><strong>&nbsp;</strong></td>
               		<td width="95" align="center"><strong>&nbsp;</strong></td>
          			<td width="10"></td>	
	            </tr>
				<tr height="20">
	            	<td width="10"></td>	
				    <td width="145" align="left"></td>
               		<td width="95" align="center"><strong>mensual</strong></td>
	                <td width="95" align="center"><strong>Precio/SMS</strong></td>
               		<td width="95" align="center"><strong>Ahorro</strong></td>
          			<td width="10"></td>	
	            </tr>
				<tr height="20">
        			<td width="10"></td>	
				    <td width="145" align="left"><strong>Mensajes a 9:</strong></td>
		            <td width="95" align="center">2 €</td>
		            <td width="95" align="center">0,09 €</td>
		            <td width="95" align="center">40 %</td>
		          	<td width="10"></td>	
		         </tr>
             </table>
		 </td>     
...
<?php
	crearTablaContratosEnServicioAhorro ($idServicioAhorro);
	crearTablaTarjetasEnServicioAhorro ($idServicioAhorro);
?> 
</table>
	...
	<tr>
  	...
  	<tr>
    	...
    	<td align="left" width="204">
   	    <?php
			crearEnlaceTarifaServicioAhorroOperador ($idServicioAhorro);
		?> 
        </td>
