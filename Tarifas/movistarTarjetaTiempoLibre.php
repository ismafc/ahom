...
<?php
	...
	$idTarjeta = isset ($_GET["idTarjeta"]) ? $_GET["idTarjeta"] : "";
	$idOperador = "";
...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Tarjeta Tiempo Libre</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Cuota de alta:</strong></td>
                    <td width="90" align="right">0 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Cuota mensual:</strong></td>
                    <td width="90" align="right">0 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Consumo mínimo mensual:</strong></td>
                    <td width="90" align="right">0 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Establecimiento de llamada:</strong></td>
                    <td width="90" align="right">0,15 €</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                    ...
                    <td width="130" align="right"><strong>Normal&nbsp;&nbsp;</strong></td>
                    <td width="90" align="right"><strong>Reducido&nbsp;</strong></td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="160" align="left"><strong>Movistar:</strong></td>
                    <td width="130" align="right">0,59 €/mín</td>
                    <td width="90" align="right">0,12 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="160" align="left"><strong>Fijos:</strong></td>
                  	<td width="130" align="right">0,59 €/mín</td>
                  	<td width="90" align="right">0,12 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="160" align="left"><strong>Móviles tipo 1:</strong></td>
                  	<td width="130" align="right">0,59 €/mín</td>
                  	<td width="90" align="right">0,12 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="160" align="left"><strong>Móviles tipo 2:</strong></td>
                    <td width="130" align="right">0,65 €/mín</td>
                    <td width="90" align="right">0,18 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="20">
                	<td width="10"></td>	
				    <td width="160" align="left"><strong>Movistar:</strong></td>
                    <td width="130" align="right">0,64 €/mín</td>
                    <td width="90" align="right">0,17 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				...
				<tr height="20">
                	<td width="10"></td>	
				    <td width="160" align="left"><strong>Móviles tipo 2:</strong></td>
                    <td width="130" align="right">0,70 €/mín</td>
                    <td width="90" align="right">0,23 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
   	...
   	<tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Movistar:</strong></td>
                    <td width="190" align="right">0,15 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Resto de operadores:</strong></td>
                  	<td width="190" align="right">0,15 €</td>
                	<td width="10"></td>	
                </tr>
             </table>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Movistar:</strong></td>
                  	<td width="190" align="right">0,28 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Resto de operadoras:</strong></td>
                    <td width="190" align="right">0,55 €</td>
                	<td width="10"></td>	
                </tr>
             </table>
    	</td>
...
<?php
	crearTablaServiciosAhorroEnTarjeta ($idTarjeta);
?> 
</table>
...
<table width="418" border="0" cellspacing="0" cellpadding="0" class="Estilo6">
	<tr>
  	...
  	<tr>
    	<td width="5"></td>
        <td width="6"><img src="./imagenes/bola2.gif"/></td>
		<td width="402" align="left">Horario Normal: Lunes a viernes de 7 a 17 horas.</td>
    	<td width="5"></td>
    </tr>
  	<tr>
    	<td width="5"></td>
        <td width="6"><img src="./imagenes/bola2.gif"/></td>
        <td width="402" align="left">Horario Reducido: Lunes a viernes de 17 a 7 horas. Sábados,</td>
    	<td width="5"></td>
    </tr>
  	<tr>
    	<td width="5"></td>
        <td width="6"></td>
        <td width="402" align="left">domingos y festivos nacionales todo el día.</td>
    	<td width="5"></td>
    </tr>
  	<tr>
    	<td width="5"></td>
        <td width="6"><img src="./imagenes/bola2.gif"/></td>
		<td width="402" align="left">Móviles tipo 1: Orange, Vodafone, Carrefour Móvil y Happy Móvil</td>
    	<td width="5"></td>
    </tr>
	<tr>
  		<td height="2"></td>
  	...
  	<tr>
    	<td width="5"></td>
        <td width="6"><img src="./imagenes/bola2.gif"/></td>
   		<td width="402" align="left">Móviles tipo 2: Yoigo y Euskaltel Móvil</td>
    	<td width="5"></td>
    </tr>
	<tr>
  		<td height="6"></td>
  	...
  	<tr>
    	<td width="5"></td>
        <td width="6"></td>
   		<td width="402" align="right">Impuestos indirectos no incluidos</td>
    	<td width="5"></td>
    </tr>
</table> 
	...
	<tr>
  	...
  	<tr>
    	...
    	<td align="left" width="204">
   	    <?php
			crearEnlaceTarifaTarjetaOperador ($idTarjeta);
		?> 
        </td>
