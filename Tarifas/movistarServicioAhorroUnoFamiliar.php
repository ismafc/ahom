...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Servicio de ahorro Uno Familiar</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Este servicio de ahorro permite agrupar líneas de contratos con un único titular con líneas de tarjeta y una línea fija de Telefónica, permitiendo beneficiarse de una tarifa reducida en las llamadas entre los teléfonos del grupo.<br />&nbsp;</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Cuota de alta (por línea):</strong></td>
				    <td width="190" align="right">3 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Cambio de número:</strong></td>
				    <td width="190" align="right">3 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Baja:</strong></td>
				    <td width="190" align="right">0 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" valign="top" align="left"><strong>Consumo mínimo:</strong></td>
				    <td width="190" align="justify">Suma de los consumos mínimos individuales de cada contrato del grupo</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>
   	...
   	<tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Números del grupo:</strong></td>
                    <td width="190" align="right">0,035 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
