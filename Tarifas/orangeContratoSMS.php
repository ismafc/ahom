...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Contrato SMS</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                    ...
                    <td width="90" align="right">0,26 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
...
<table width="418" border="0" cellspacing="0" cellpadding="0" class="Estilo6">
	<tr>
  	...
  	<tr>
		...
		<td width="402" align="left">Límite de SMS a 0€: 150 SMS/ciclo de facturación</td>
    	<td width="5"></td>
    </tr>	
	<tr>
  		<td height="2"></td>
  	...
  	<tr>
    	<td width="5"></td>
        <td width="6"><img src="./imagenes/bola2.gif"/></td>
		<td width="402" align="left">Una vez superado el límite se aplicará  0,15 € por SMS enviado</td>
    	<td width="5"></td>
    </tr>	
	<tr>
  		<td height="6"></td>
