...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Contrato 2</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Hasta 450 minutos:</strong></td>
                    <td width="190" align="right">0 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>A partir de 450 minutos:</strong></td>
                  	<td width="190" align="right">0,12 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
...
<table width="418" border="0" cellspacing="0" cellpadding="0" class="Estilo6">
	<tr>
  	...
  	<tr>
		...
		<td width="402" align="left">Incluye 450 minutos en llamadas nacionales a fijos o móviles y 40 mensajes de texto</td>
    	<td width="5"></td>
    </tr>
	<tr>
  		<td height="6"></td>
