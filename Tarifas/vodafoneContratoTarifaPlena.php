...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Contrato Tarifa Plena</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="20">
                    ...
                    <td width="190" align="right">60 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Cualquier destino hasta 120€:</strong></td>
                    <td width="90" align="right">0,16 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Cualquier destino a partir de 120€:</strong></td>
                  	<td width="90" align="right">0 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
...
<table width="418" border="0" cellspacing="0" cellpadding="0" class="Estilo6">
	<tr>
  	...
  	<tr>
		...
		<td width="402" align="left">Las llamadas nacionales que se realicen a partir de 120€ son gratuitas.</td>
    	<td width="5"></td>
    </tr>
  	<tr>
    	<td width="5"></td>
        <td width="6"><img src="./imagenes/bola2.gif"/></td>
		<td width="402" align="left">A partir de 420€ se aplicará la tarifa del plan de precios.</td>
    	<td width="5"></td>
    </tr>
    <tr>
    	<td width="5"></td>
