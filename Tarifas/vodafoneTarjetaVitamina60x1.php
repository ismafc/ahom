...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Tarjeta Vitamina 60x1</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hable 60 minutos y pague solo 1 en llamadas nacionales a fijo y móviles Vodafone.<br />
					  &nbsp;</td>
                	<td width="10"></td>	
                </tr>
                <tr height="20">
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" colspan="2" align="left"><strong>Vodafone</strong></td>
				...
				<tr height="20">
				    ...
				    <td width="270" align="left"><strong>- Llamadas de 1 a 60 minutos:</strong></td>
                    <td width="90" align="right">0,50 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Llamadas de más de 60 minutos:</strong></td>
                    <td width="90" align="right">0,35 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				...
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" colspan="2" align="left"><strong>Resto de operadores</strong></td>
                  	<td width="90" align="right"></td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Cualquier duración:</strong></td>
                  	<td width="90" align="right">0,35 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
