...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Tarjeta Mi Tiempo Libre</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" colspan="2" align="left"><strong>Fijos y móviles</strong></td>
				...
				<tr height="20">
				    ...
				    <td width="270" align="left"><strong>- Lunes a viernes de 8:00h a 17:00h:</strong></td>
                    <td width="90" align="right">0,55 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Lunes a viernes de 17:00h a 8:00h:</strong></td>
                    <td width="90" align="right">0,10 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Fines de semana y festivos:</strong></td>
                    <td width="90" align="right">0,10 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Cualquier destino:</strong></td>
   	...
   	<tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Nacional:</strong></td>
                    <td width="90" align="right">0,15 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Internacional:</strong></td>
                  	<td width="90" align="right">0,60 €</td>
                	<td width="10"></td>	
                </tr>
             </table>
    	</td>
...
<table width="418" border="0" cellspacing="0" cellpadding="0" class="Estilo6">
	<tr>
  	...
  	<tr>
    	<td width="5"></td>
        <td width="6" valign="top"><img src="./imagenes/bola3.gif"/></td>
		<td width="402" align="justify">Para aplicar la tarifa debe realizar una recarga igual o superior a 10€ durante un mes desde la fecha de recarga.<br />Si no se realiza dicha recarga se aplicará una tarifa de 0,59 €/mín en las llamadas de 8:00h a 17:00h de lunes a viernes y de 0,15 €/mín en las llamadas de 17:00h a 8:00h de lunes a viernes, fines de semana y festivos nacionales.</td>
    	<td width="5"></td>
    </tr>	
    <tr>
  		<td height="6"></td>
