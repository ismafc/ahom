...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Tarjeta movistar</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                    ...
                    <td width="190" align="right">0,05 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Fijos:</strong></td>
                  	<td width="190" align="right">0,59 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Móviles tipo 1:</strong></td>
                  	<td width="190" align="right">0,59 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Móviles tipo 2:</strong></td>
                    <td width="190" align="right">0,65 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Movistar:</strong></td>
                    <td width="190" align="right">0,10 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Fijos:</strong></td>
                  	<td width="190" align="right">0,64 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				...
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Móviles tipo 2:</strong></td>
                    <td width="190" align="right">0,70 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
