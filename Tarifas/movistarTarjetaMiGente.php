...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Tarjeta Mi Gente</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Modificación de número:</strong></td>
                    <td width="90" align="right">3 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                    ...
                    <td width="130" align="right"><strong>Números elegidos</strong></td>
                    <td width="90" align="right"><strong>Otros&nbsp;&nbsp;&nbsp;&nbsp;</strong></td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="160" align="left"><strong>Movistar:</strong></td>
                    <td width="130" align="right">0,05 €/mín&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td width="90" align="right">0,45 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				...
				<tr height="20">
                    ...
                    <td width="130" align="right">0,11 €/mín&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td width="90" align="right">0,51 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="20">
                	<td width="10"></td>	
				    <td width="160" align="left"><strong>Movistar:</strong></td>
                    <td width="130" align="right">0,10 €/mín&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td width="90" align="right">0,50 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				...
				<tr height="20">
                	<td width="10"></td>	
				    <td width="160" align="left"><strong>Móviles tipo 2:</strong></td>
                    <td width="130" align="right">0,16 €/mín&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td width="90" align="right">0,56 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
        </td>     
   	...
   	<tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Números elegidos:</strong></td>
                    <td width="190" align="right">0,10 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Otros:</strong></td>
