...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Contrato Mi Tiempo Libre</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Podrá escoger una franja de 5h entre las 8:00h y las 22:00h donde tendrá una tarifa reducida. <br />
					  &nbsp;</td>
                	<td width="10"></td>	
                </tr>
                <tr height="20">
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="20">
				    ...
				    <td width="270" align="left"><strong>- 5h entre las 8:00h y las 22:00h:</strong></td>
                    <td width="90" align="right">0,07 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Laborables de 22:00h a 8:00h:</strong></td>
                    <td width="90" align="right">0,07 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
				...
				<tr height="20">
                	<td width="10"></td>	
				    <td width="20" align="left"></td>
				    <td width="270" align="left"><strong>- Laborables fuera del horario elegido:</strong></td>
