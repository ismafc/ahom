...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Servicio de ahorro 100 Minutos</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Al contratar este servicio de ahorro disfrutará de 100 minutos al mes por 0€ para llamar a fijos y móviles de cualquier operadora, todas las noches y los fines de semana.<br />&nbsp;</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				...
				<tr height="20">
                    ...
                    <td width="190" align="right">10 €</td>
                	<td width="10"></td>	
                </tr>
			 </table>
        </td>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="310" align="left"><strong>Lunes a viernes de 23:00h a 8:00h:</strong></td>
                  	<td width="70" align="right">0 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="310" align="left"><strong>Fines de semana:</strong></td>
                  	<td width="70" align="right">0 €</td>
                	<td width="10"></td>	
                </tr>
             </table>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Resto:</strong></td>
