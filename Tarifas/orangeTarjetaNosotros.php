...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Tarjeta Nosotros</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                    ...
                    <td width="90" align="right">0,03 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Fijos:</strong></td>
                    <td width="90" align="right">0,50 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Resto de operadores:</strong></td>
                    <td width="90" align="right">0,50 €/mín</td>
                	<td width="10"></td>	
                </tr>
             </table>
...
<table width="418" border="0" cellspacing="0" cellpadding="0" class="Estilo6">
	<tr>
  	...
  	<tr>
		...
		<td width="402" align="justify">Para aplicar la tarifa debe realizar una recarga igual o superior a 10€ durante un mes desde la fecha de recarga.<br />Si no se realiza dicha recarga se aplicará una tarifa de 0,20 €/mín para llamadas a Orange y 0,59 €/mín a fijos y resto de operadores móviles.</td>
    	<td width="5"></td>
    </tr>	
    <tr>
  		<td height="6"></td>
