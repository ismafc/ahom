...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Contrato Carrefour</strong></td>
    	<td width="2"></td>
    </tr>
	<tr>
	    <td colspan="3" height="6"></td>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Carrefour:</strong></td>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Cualquier destino:</strong></td>
                  	<td width="190" align="right">0,50 €</td>
                	<td width="10"></td>	
                </tr>
             </table>
    	</td>
