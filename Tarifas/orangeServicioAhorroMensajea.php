...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Servicio de ahorro Mensajea</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Podrá crear un grupo de hasta 10 personas, con las que tendrá tarifa reducida al enviar mensajes.<br />&nbsp;</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Cuota de alta:</strong></td>
                    <td width="190" align="right">3 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
   	...
   	<tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>A 1 persona del grupo:</strong></td>
                    <td width="190" align="right">0,03 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>A todo el grupo:</strong></td>
                    <td width="190" align="right">0,18 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="190" align="left"><strong>Otros:</strong></td>
                  	<td width="190" align="right">Según modalidad contratada</td>
                	<td width="10"></td>	
                </tr>
             </table>
    	</td>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="310" align="left"><strong>A 1 persona del grupo:</strong></td>
                  	<td width="70" align="right">0,30 €</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
				    <td width="310" align="left"><strong>A todo el grupo:</strong></td>
...
<table width="418" border="0" cellspacing="0" cellpadding="0" class="Estilo6">
	<tr>
  	...
  	<tr>
		...
		<td width="402" align="justify">Límite de 1000 mensajes (SMS y/o MMS) individuales y 1000 grupales. Superado ese límite será tarificado según la modalidad contratada.</td>
    	<td width="5"></td>
    </tr>	
	<tr>
  		<td height="2"></td>
  	...
  	<tr>
    	<td width="5"></td>
        <td width="6" valign="top"><img src="./imagenes/bola3.gif"/></td>
		<td width="402" align="justify">Máximo 10 personas por grupo. Mínimo 2.</td>
    	<td width="5"></td>
    </tr>	
  	<tr>
  		<td height="6"></td>
