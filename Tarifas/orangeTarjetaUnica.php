...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Tarjeta &Uacute;nica</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                	<td width="10"></td>	
				    <td width="290" align="left"><strong>Fijos y móviles:</strong></td>
...
<table width="418" border="0" cellspacing="0" cellpadding="0" class="Estilo6">
	<tr>
  	...
  	<tr>
		...
		<td width="402" align="justify">Para aplicar la tarifa debe realizar una recarga igual o superior a 15€ durante un mes desde la fecha de recarga.<br />Si no se realiza dicha recarga se aplicará una tarifa de 0,35 €/mín.</td>
    	<td width="5"></td>
    </tr>	
    <tr>
  		<td height="6"></td>
