...
<table width="418" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
    	<td width="2"></td>
        <td width="414" align="center"><strong>Servicio de ahorro 5 de Orange</strong></td>
    	<td width="2"></td>
	<tr>
	    <td colspan="3" height="6"></td>
	</tr>
    ...
    <tr>
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td width="10"></td>	
					<td colspan="2" width="380" align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Podrá elegir 5 números de Orange con los que podrá llamar por 3 cent./mín las 24h de lunes a domingo. <br />&nbsp;</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
        ...
        <td width="400" style="background-color:#D7E9F5">
        	<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr height="20">
                    ...
                    <td width="230" align="right">0,03 €/mín</td>
                	<td width="10"></td>	
                </tr>
				<tr height="20">
                	<td width="10"></td>	
...
<table width="418" border="0" cellspacing="0" cellpadding="0" class="Estilo6">
	<tr>
  	...
  	<tr>
		...
		<td width="402" align="left">La cuota mensual será de 0€ si el consumo es igual o superior a 24€</td>
    	<td width="5"></td>
    </tr>	
      	<tr>
  		<td height="6"></td>
