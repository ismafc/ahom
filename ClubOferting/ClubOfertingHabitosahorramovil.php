...
<iframe src="procesandoAhorramovil.php" id="fahorramovilmsg" name="fahorramovilmsg" width="100%" height="0" scrolling="auto" frameborder="0" style="visibility:hidden">No soporta Frames
	...
	<tr>
    	<td>
<iframe src="formularioHabitosAhorramovil.php" id="fahorramovil" name="fahorramovil" width="100%" height="<?php echo $_SESSION["heightClubOferting"]; ?>" scrolling="auto" frameborder="0">No soporta Frames
</iframe>
		</td>
    </tr>    
</table>
