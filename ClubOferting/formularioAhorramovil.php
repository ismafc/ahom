...
?>
    ...
    <table class="texto" cellspacing="0" cellpadding="0" border="0" width="100%" style="height:100%;font-size:11px;">
        <tr>
            <td colspan="3">
                <div class="texto"><strong>¡Encuentra el mejor precio!</strong> Ahora <span style="color:#EB7D18;">ClubOferting</span> te ofrece un nuevo servicio gratuito que te resolverá de forma definitiva cuál es el plan
