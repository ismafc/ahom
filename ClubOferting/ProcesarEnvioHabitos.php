...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
    ...
    <?php
    crearTablaResultadosHabitosClubOferting($idMiembro, $numero_movil_llamante);
    ?>
    <tr><td colspan="3" style="height:20px"></td></tr>
    <tr>
        <td colspan="3" align="center" class="texto"><a style="color:#EB7D18;" href="http://www.cluboferting.com/telefonia/comparar/" target="_top">Volver al formulario inicial</a></td>
    </tr>
	</table>
 	<?php
	if (esProvisional ($login, $password)){
