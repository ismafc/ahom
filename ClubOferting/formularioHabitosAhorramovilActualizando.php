...
<body>
<div class="main">
	<div class="texto"><strong>¡Encuentra la mejor opción!</strong> Ahora <span style="color:#EB7D18;">ClubOferting</span> te ofrece un nuevo servicio gratuito que te resolverá de forma definitiva cuál es el plan
	...
	<table class="fields" cellspacing="0" cellpadding="0" border="0" width="625" style="font-size:11px;">
		...
		<tr>
			<td class="texto" align="center" style="color:#EB7D18; font-size:20px;">Servicio temporalmente deshabilitado. Disculpad las molestias.</td>
	   </tr>
	</table>
</div>
