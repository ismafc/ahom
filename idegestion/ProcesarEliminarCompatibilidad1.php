...
<table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="579"> <div align="left">Ahorramovil Tarifas. Compatibilidades. Eliminar compatibilidad </div></td>
	  </tr>
    </table>
	  <br />

 <p>&nbsp;</p>
 <form id="form1" method="post" action="CompatibilidadEliminada1.php">	
 <table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
 ...
 <table width="570" border="1" align="center" cellpadding="0" cellspacing="0">
   <tr>
	 ...
	 <td class="Estilo53"><div align="center">&nbsp;</div></td>
	 </tr>
   ...
   // Extreiem la informació de les compatibilitats existents pel contracte					
			...
			else
				{
						...
						/*	echo "<tr>" ;
							...
							if ($i > 0 and $idCompatibilidad [$i] != $idCompatibilidad [$i-1]) {
							echo "<td><div align=\"center\">";
							echo "<input type=\"checkbox\" name=\"checkbox".$i."\" value=\"1\" />";
							echo "<input type=\"hidden\" name=\"compatibilidad".$i."\" value=\"".$idCompatibilidad [$i]."\">";
							echo "</td>";
 ...
 <table width="570" align="center">
	   <tr>
	     <td width="481" class="Estilo53">&nbsp;</td>
	     <td width="10" class="Estilo53">&nbsp;</td>
	     <td width="483" class="Estilo53">&nbsp;</td>
   </tr>
	   <tr>
	     <td class="Estilo53"><div align="right">
	       <input name="Restablecer" type="reset" value="           Restablecer  &gt;&gt;           " />
         </div></td>
	     <td class="Estilo53">&nbsp;</td>
	     <td class="Estilo53">
		   <div align="left">
		     <input name="Enviar" type="submit" value="   Eliminar compatibilidades  &gt;&gt;" />
           </div></td>
   </tr>
</table> 
