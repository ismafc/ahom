...
<table border="1">
	<?php
		...
		for ($i = 0; $i < mysql_num_rows($result); $i++) {
			...
			echo "<td width=100 align=center><a href=\"GestionServiciosDeAhorroProcesar.php?id=".$row_array[0]."\"/>Cambiar</a></td>";
			echo "<td width=100 align=center><a href=\"GestionServiciosDeAhorroEliminar.php?id=".$row_array[0]."\"/>Eliminar</a></td>";
			echo "</tr>";
		}
	?>
</table>
<br />
<br />
<a href="GestionServiciosDeAhorroProcesar.php"><strong>Nuevo servico de ahorro</strong></a>
</body>
</html>
