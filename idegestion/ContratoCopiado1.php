...
<table width="570" border="0" cellpadding="0" cellspacing="0">
 ...
 <table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
     <td class="Estilo53"><div align="center" class="Estilo55">Nuevos Datos del Contrato </div></td>
   </tr>
 </table>
 <p>&nbsp;</p>
 <form action="ProcesarContratoCopiado1.php" method="post" target="_self" id="form1">
    <table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="495" class="Estilo53"><div align="right">Nombre del contrato </div></td>
        <td width="11">&nbsp;</td>
        <td width="484"><label>
          <input name="NombreContratoNuevo" type="text" class="Estilo53" id="Nombre" />
        </label></td>
      </tr>
      <tr>
	...
	<?php
	echo "<input type=\"hidden\" name=\"idContratoViejo\" value=\"" . $idContrato . "\">";
	?>
