...
$idContrato = $_POST["idContrato"];
	...
	// Mirem les compatibilitats que s'han seleccionat, en principi fins un màxim de 20, ja que les i estan alternades i no es pot estar segur de fer un break su bi estan set
