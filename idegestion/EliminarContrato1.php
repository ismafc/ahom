...
<table width="570" border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="579"> <div align="left">Ahorramovil Tarifas. Contratos. Eliminar contrato </div></td>
	  </tr>
    </table>
	  <br />
...
<table width="579" border="0" cellspacing="0" cellpadding="0">
 ...
 <p>&nbsp;</p>
 <form action="ProcesarEliminarContrato1.php" method="post" target="_self" id="form1">
    <table width="579" border="0" align="center" cellpadding="0" cellspacing="0">

      <tr>
        <td width="281" class="Estilo53"><div align="right">Escoge el contrato </div></td>
        <td width="17"></td>
        <td width="281"><label>
