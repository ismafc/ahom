...
<table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
     <td class="Estilo53"><div align="center" class="Estilo55">Escoge el contrato del que se elimina la compatibilidad </div></td>
   </tr>
 </table>
 <p>&nbsp;</p>
 <form action="ProcesarEliminarCompatibilidad1.php" method="post" target="_self" id="form1">
    <table width="570" border="0" align="center" cellpadding="0" cellspacing="0">
