...
Nuevos contratos, nuevos operadores, etc...<br/>
  ...
  <div id="areaTexto">
	...
	<div id="contenido">
<form name="FormularioEliminar" id="FormularioEliminar" method="post" action="zonaUsuarioProcesarEliminarFacturas.php">
  <table width="378"  border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="25" colspan="3" valign="middle"><div align="center"><strong><?php echo $numero_movil_llamante; ?></strong></div></td>
    </tr>    
    <tr>
      <td colspan="3"><div align="center">Selecciona las facturas a eliminar</div></td>
    </tr>    
    <tr>
      <td height="20" colspan="3"></td>
    </tr>    
	<?php
		$sql = "SELECT id, periodo FROM facturas WHERE idMiembro = '$idMiembro' AND numero_movil_llamante = '$numero_movil_llamante'";
		$result = mysql_query($sql);
		if ($result == 0) {
			echo "<b>Error " . mysql_errno() . ": " . mysql_error() . "</b>";
			exit();
        ...
        for ($i = 0; $i < mysql_num_rows($result); $i++) {
            ...
            $periodo = $row_array[1];
            echo "<tr>";
            echo "<td width=\"450\" height=\"20\" class=\"Estilo37\"><div align=\"right\">" . $periodo . "</div></td>";
            echo "<td width=\"13\"></td>";
            echo "<input type=\"hidden\" name=\"Id" . $nfactura . "\" value=\"" . $id . "\">";
            echo "<td width=\"127\" height=\"20\"><input name=\"Check" . $nfactura . "\" type=\"checkbox\" id=\"Check" . $nfactura . "\" value=\"1\"></td>";
            $nfactura++;
        }
        echo "<input type=\"hidden\" name=\"NumeroFacturas\" value=\"" . $nfactura . "\">";
    ...
    <tr>
      <td height="22" colspan="3">        
          <div align="center">
          	<img src="imagenesmastreces/contenido/fondoUsuarioBotonBorrar.gif" alt="" border="0" onclick="validateAndSubmit(<?php echo $nfactura; ?>);" style="cursor:pointer" />          </div></td>
      </tr>
    <tr>
