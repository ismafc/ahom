...
<?php
    ...
    <div id="login">
      ...
      <table width="152" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><div align="left"><strong>Desde tu zona de usuario puedes:</strong></div></td>
        </tr>
        <tr>
          <td height="10"></td>
        </tr>
...
//	$sql = "INSERT INTO miembros (Login, Password, Creado, Nombre, Apellido1, Apellido2, Estado, Nacimiento, Sexo";
	$sql = "UPDATE miembros SET Login = '$usuario', Password = '$password', Nombre = '$nombre', Estado = 'INACTIVO'";
	if ($mail != false)
		$sql = $sql . ", Correo = '$mail'";
	...
	if ($result == 0) {
		...
		<table width="378"  border="0" cellspacing="0" cellpadding="0">
		  <tr>
		    <td height="30"> El usuario <?php echo $usuario; ?> ya existe. <a href="zonaUsuarioMDP.php">Int&eacute;ntalo de nuevo con otro nombre de usuario.</a> </td>
		  </tr>
	  </table>
		<?php
		}
...
?>
  <table width="378"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="30" colspan="3"> <div align="center">Tus datos han sido actualizados </div></td>
    </tr>
    <tr>
